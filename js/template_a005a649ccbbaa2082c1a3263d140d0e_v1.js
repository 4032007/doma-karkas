...
; /* Start:"a:4:{s:4:"full";s:73:"/bitrix/components/arturgolubev/search.title/script.min.js?17455813056313";s:6:"source";s:54:"/bitrix/components/arturgolubev/search.title/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:61:"/local/templates/doma-karkas/js/jquery-ui.js?1705916048529159";s:6:"source";s:44:"/local/templates/doma-karkas/js/jquery-ui.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:75:"/local/templates/doma-karkas/js/jquery.ui.touch-punch.min.js?17059160491291";s:6:"source";s:60:"/local/templates/doma-karkas/js/jquery.ui.touch-punch.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:71:"/local/templates/doma-karkas/js/jquery.inputmask.min.js?170591604899426";s:6:"source";s:55:"/local/templates/doma-karkas/js/jquery.inputmask.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:61:"/local/templates/doma-karkas/js/webform.min.js?17061081668231";s:6:"source";s:46:"/local/templates/doma-karkas/js/webform.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
!function(t,e,n){var i={async:!0,isFile:!1,handler:!!t._SITE&&t._SITE.FORM_HANDLER||location.href,require:[".req > :input, .req:input"],"error-class":"error",phone:[".phone > input, .phone:input"],"phone-mask":"+7 (999) 999 9999","phone-mask-params":{},checkbox:['.checkbox > input[type="checkbox"]'],"checkbox-auto":!1,"checkbox-params":{checkboxCls:"ez-checkbox-green",checkedCls:"ez-checked-green"},mail:[".mail > input",".mail > textarea, .mail:input"],button:[],"file-handler":null,"file-async":!0,timeout:5e3,processChangeEvents:!0,enterKey:!0,reset:!0,resetHidden:!1,serializeFunction:"serializeArray",dataType:"json",onChange:null,onCheck:null,onCheckFailed:null,onCheckSuccess:null,onCheckRequest:null,onDataPrepare:null,onStart:null,onBeforeSend:null,onSend:null,onError:null,onSuccess:null},a=function(t){return t instanceof e},o=function(t,n){var o=a(t),r="string"==typeof t,s=o?t:e(r);if(s.length<=0)throw new Error("Wrong form element");this.__el=s,this.__params=e.extend(!0,{},i,n||{});var h=this;e((function(){h.__init()}))},r=function(t,e,n){var i;this.el=t,this.el.after('<div data-container class="file-container"><ul></ul></div>'),this.container=this.el.next("[data-container]"),this.handler=e,this.name=n||t.attr("name"),this._form=null,this._hash=n+"_"+function(t){var e,n=0;for(e=0;e<t.length;e++)n=(n<<5)-n+t.charCodeAt(e),n|=0;return n}((i||new Date).getTime()+""),this.init()},s='style="visibility: hidden;position: absolute;"';r.prototype={init:function(){var t=this;this.createForm(),this.el.on("click",(function(e){e.preventDefault(),t.click()})),this.container.on("click",".file-delete",(function(){e(this).parent("li").remove()}))},click:function(){var t=this,e=this.el.clone(!1).off("click");this._form.append(e),e.one("change",(function(){t.upload()})),e.trigger("click")},createForm:function(){this._form||(this._form=e('<form target="'+this._hash+'" '+s+' action="'+this.handler+'" method="post" enctype="multipart/form-data"></form>'),this._form.append('<input name="sessid" value="'+(BX&&BX.bitrix_sessid?BX.bitrix_sessid():"")+'" /><input type="button" value="button">'),this.toBody(this._form))},upload:function(){var t=this,n=e('<iframe id="'+this._hash+'" name="'+this._hash+'" src="javascript:true" '+s+"></iframe>");n.one("load",(function(){n.one("load",(function(){var n=e(this);t.proccessData(n.contents().text()),n.remove(),t._form.find('input[type="file"]').remove()})),t._form.submit()})),this.toBody(n)},toBody:function(t){this._body||(this._body=e("body")),this._body.append(t)},proccessData:function(t){var e;try{e=JSON.parse(t),console.log(e)}catch(t){console.log("Server response is wrong. Expected json")}if(e)for(var n=0;n<e.length;n++)this.addUploaded(e[n])},addUploaded:function(t){this.el.prop("multiple")||this.container.find("ul").html(""),this.container.find("ul").append('<li><div class="file-filename">'+(t.file||"")+'</div><input type="hidden" name="'+(t.name||"")+'" value="'+(t.value||"")+'"><div class="file-delete">―</div></li>')}},o.prototype.getElement=function(){return this.__el},o.prototype.findChilds=function(t){var n,i=this.getElement(),o=t||[];e.isArray(o)||(o=[o]);for(var r=0;r<o.length;r++){var s=o[r],h=a(s)?s:i.find(s);n?n=n.add(h):n=h}return n||e()},o.prototype.getPhones=function(){return this.findChilds(this.getParam("phone"))},o.prototype.getMails=function(){return this.findChilds(this.getParam("mail"))},o.prototype.getRequiredFields=function(){return this.findChilds(this.getParam("require"))},o.prototype.getCheckBoxes=function(){var t=this.getParam("checkbox"),e=this.getParam("checkbox-auto");return this.findChilds(e&&!t||t.length<=0?['input[type="checkbox"]']:t)},o.prototype.getParam=function(t){return t?this.__params[t]:this.__params},o.prototype.__init=function(){this.__initInputs(),this.__initButtons(),this.__initOnChange(),this.callEvent("onStart")},o.prototype.__initInputs=function(){var t=this,n=this.getPhones(),i=this.getCheckBoxes();if(n.length>0){var a=e.extend({clearIncomplete:!0},t.getParam("phone-mask-params")),o=t.getParam("phone-mask");o&&(a=e.extend(a,{mask:o})),function(t,e){"function"==typeof t.inputmask&&t.inputmask(e)}(n,a)}if(i.length>0&&function(t,e){"function"==typeof t.ezMark&&t.ezMark(e)}(i,t.getParam("checkbox-params")),!0===this.getParam("file-async")){var s=this.getParam("file-handler");s&&this.findChilds('input[type="file"][name]').each((function(){var t=e(this),n=t.attr("name");if(n)new r(t,s,n)}))}},o.prototype.getButtons=function(){var t=this.getParam("button");return this.findChilds(t&&t.length>0?t:['input[type="button"],button[type="submit"]'])},o.prototype.__initButtons=function(){var t=this,n=this.getButtons();n.off("click.form").on("click.form",(function(){!0!==e(this).prop("disabled")&&t.send()})),!0===this.getParam("enterKey")&&this.findChilds("input, textarea").off("keypress.form").on("keypress.form",(function(t){var i=e(this);13!==t.which&&10!==t.which||i.is("textarea")&&!t.ctrlKey||n.trigger("click")}))},o.prototype.__killChangeCounter=function(){this.__change_counter&&(clearTimeout(this.__change_counter),delete this.__change_counter)},o.prototype.__startChangeCounter=function(t){var e=this;this.__change_counter=setTimeout((function(){e.onChange(t)}),50)},o.prototype.__initOnChange=function(){if(!0===this.getParam("processChangeEvents")){var t=this;this.findChilds("input, select, textarea").on("change",(function(){t.__killChangeCounter(),t.onChange(this)})).on("keyup",(function(){t.__killChangeCounter(),t.__startChangeCounter(this)})),t.onChange()}},o.prototype.onChange=function(t){this.callEvent("onChange",[this.getElement(),t]),this.getButtons().prop("disabled",this.checkForm())},o.prototype.reset=function(){var t=this.findChilds(":input, textarea, select");!0!==this.getParam("resetHidden")&&(t=t.not('[type="hidden"]'));var e=t.filter(":checkbox, :radio"),n=t.filter("select");n.prop("selectedIndex",0),t.filter("textarea").val(""),e.prop("checked",!1),t.not(e).not(n).val("")},o.prototype.send=function(){if(!0===this.__sending__)return;var t=this.getElement(),n=this.checkForm(),i=this.getButtons(),a=this;if(!1===this.callEvent("onBeforeSend",[t])&&(n=!0),n)return;this.__sending__=!0,i.addClass("pending"),this.callEvent("onSend");let o="Форма футера";e(".tit-pop-call").length>0&&(o=e(".tit-pop-call").text());let r={async:this.getParam("async"),url:this.getParam("handler"),data:this.getFormData(),type:"POST",processData:!1,contentType:!1,timeout:this.getParam("timeout"),dataType:this.getParam("dataType"),success:function(t,e,n){var i=[t,a.getElement()],o=!1!==a.callEvent("onCheckRequest",i);a.callEvent(o?"onSuccess":"onError",i),o&&!0===a.getParam("reset")&&a.reset()},error:function(){a.callEvent("onError",arguments)},complete:function(){a.__sending__=!1,i.removeClass("pending")}};this.isFile&&(r.processData=!1,r.processData=!1),e.ajax(r)},o.prototype.getFormData=function(){let t=new FormData,e=this.findChilds("input, textarea, select, :input")[this.getParam("serializeFunction")]();e.forEach((function(e){t.append(e.name,e.value)}));let n=this.__el[0].querySelectorAll('input[type="file"]');return n.length>0&&(this.isFile=!0,n.forEach((function(e){e.files.length>0&&t.append(e.name,e.files[0])}))),this.callEvent("onDataPrepare",[e]),t},o.prototype.checkForm=function(){var t=this,n=this.getElement(),i=!1,a=this.getMails(),o=this.getPhones(),r=this.getRequiredFields();return a.each((function(){var n=e(this),a=r.filter(n).length>0,o=n.val(),s=(o||a)&&!isMail(o);s&&(i=!0),t.markInput(n,s)})),o.each((function(){var n=e(this),a=r.filter(n).length>0,o=n.val(),s=(o||a)&&"function"==typeof n.inputmask&&!n.inputmask("isComplete");s||!a||o||(s=!0),s&&(i=!0),t.markInput(n,s)})),r.not(a).not(o).each((function(){var n=e(this),a=!n.val();a&&(i=!0),t.markInput(n,a)})),!1===this.callEvent("onCheck",[n])&&(i=!0),this.callEvent(i?"onCheckFailed":"onCheckSuccess",[n]),i},o.prototype.markInput=function(t,n){e(t)[n?"addClass":"removeClass"](this.getParam("error-class"))},o.prototype.callEvent=function(t,e){var n=this.getParam(t);if("function"==typeof n)try{return n.apply(t,e)}catch(n){}},window.WebForm=o,t.isMail||(t.isMail=function(t){return/^[=_.0-9a-z+~-]+@(([-0-9a-z_]+\.)+)([a-z]{2,10})$/i.test(t)})}(window,jQuery);
/* End */
;
; /* Start:"a:4:{s:4:"full";s:56:"/local/templates/doma-karkas/js/cookie.js?17416205741471";s:6:"source";s:41:"/local/templates/doma-karkas/js/cookie.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function ($, w, d) {
	if (w.SiteCookie) return;
	...
	class SiteCookie {
		...
		encodeKey(key) { return key.split('-').join('_'); }

		decodeKey(key) { return key.split('-').join('_'); }
	}

	w.SiteCookie = new SiteCookie();
})(jQuery, window, document);

/* End */
;
; /* Start:"a:4:{s:4:"full";s:57:"/local/templates/doma-karkas/js/script.js?174703438018341";s:6:"source";s:41:"/local/templates/doma-karkas/js/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
function callYmGoal(instance, wForm, formData) {
	console.log('callYmGoal')
	let text = $(wForm).find('[name="web_form_name"]').val(), textFormat = ''
	textFormat = text.trim()
	if (textFormat === 'Заказать звонок') textFormat = '-call-me'
	if (textFormat === 'Рассчитать проект' || textFormat === 'Получить смету') textFormat = '-calc-project'
	if (textFormat === 'ОТПРАВЬТЕ ЗАЯВКУ НА УЧАСТИЕ В АКЦИИ ПРЯМО СЕЙЧАС!') textFormat = '-action'
	if (textFormat === 'Заказать строительство') textFormat = '-order-construct'
	if (textFormat === 'Посетить объект') textFormat = '-visit'
	if (textFormat === 'Договоримся о нашей встрече!') textFormat = '-meeting'
	if (textFormat === 'Купить в кредит') textFormat = '-credit'
	if (textFormat === 'Узнать стоимость дома под ключ') textFormat = '-cost-turnkey-house'
	if (textFormat === 'Хотите внести правки в проект?') textFormat = '-changes-project'
	if (textFormat === 'Мы рады ответить на Ваши вопросы лично!') textFormat = '-answer-question'
	if (textFormat === 'Купить проект дома'|| textFormat === 'Купить проект') textFormat = '-buy-project'
	textFormat = textFormat.trim().replaceAll(' ', '-')

	ym(22595095, 'reachGoal', 'send-form' + textFormat, {title_form: text});
	if (typeof dataLayer != 'undefined') dataLayer.push({'event': 'send-form-' + text});
}

$(function () {
	const $body = $('body');
	Fancybox.bind('[data-fancybox]', {});
	Fancybox.bind('[data-fancybox="images1"], [data-fancybox="images2"], [data-fancybox="images3"], [data-fancybox="images4"], [data-fancybox="images5"], [data-fancybox="images6"], [data-fancybox="images7"], [data-fancybox="images7"]', {
		Thumbs: {
			type: "classic"
		},
		showClass: "ff-fadeIn",
	...
	$body.off('click.list-ask').on('click.list-ask', '.list-ask .head-ask-accord', function () {
		let $self = $(this)
		$self.toggleClass('active')
		$self.parent().find('.body-ask-accord').toggle()
	})

	window.Site.GetWebForm = function (data) {
		window.Site.ajaxCall({
			url: window.Site.SITE_TEMPLATE_PATCH + '/ajax/form_template.php', dataType: 'text', func: function (resp) {
				let webBlockId = 'ajax_web_form'
				$(`#${webBlockId}`).remove()
				let $cont = $(`<div id="${webBlockId}">` + resp + '</div>')
				$cont.hide()
				$('body').append($cont)
				if (data.title) $cont.find('[data-title]').html(data.title)
				if (data.opt) {
					if (data.opt.city)
						$cont.find('[data-is-city]').val(data.opt.city)
					if (data.opt.is_credit_other) {
						let title = $('[data-other-select] option:selected:last').data('title')
						$cont.find('[data-home-name]').val(title)
					}
					if (data.opt.home_title) {
						$cont.find('[data-home-name]').val(data.opt.home_title)
					}
				}

				if (data.eventAfterAjax) data.eventAfterAjax(`#${webBlockId}`)
			}, data: {WEB_FORM_ID: data.id, formTitle: data.title, mark: data.mark || ''}
		})
	}
	window.Site.ShowModal = function ($html) {
		new Fancybox([{src: $html, type: "inline",},]);
	}

	$('[data-get-form]').on('click', function () {
		let $self = $(this)
		let title = this.dataset.title, url = this.dataset.getForm, id = this.dataset.wf, opt = $self.data('opt')
		if (!opt) opt = {}
		if (this.dataset.city !== undefined) opt.city = this.textContent

		window.Site.GetWebForm({
			id: id, title: title, mark: this.dataset.mark, opt: opt,
			eventAfterAjax: window.Site.ShowModal
		})
	})

//sliders
	const $mainImgCard = $('.main-img-card')
	$mainImgCard.on('init', function (event, slick) {
		$('.count-pag-card').text(parseInt(slick.currentSlide + 1) + ' из ' + slick.slideCount);
	});

	$mainImgCard.on('afterChange', function (event, slick, currentSlide) {
		$('.count-pag-card').text(parseInt(slick.currentSlide + 1) + ' из ' + slick.slideCount);
	});
	$mainImgCard.slick({
		slidesToShow: 1,
	...
	$('.slider-spec-sertif').slick({
		infinite: false,
		prevArrow: $('.prev-sertif'),
		nextArrow: $('.next-sertif'),
		appendDots: $('.pag-sertif'),
		dots: true,
		slidesToShow: 6,
		slidesToScroll: 1,
		responsive: [
	...
	$('.slider-final-video').slick({
		infinite: false,
		prevArrow: $('.prev-final'),
		nextArrow: $('.next-final'),
		appendDots: $('.pag-final'),
		dots: true,
		slidesToShow: 1,
		slidesToScroll: 1
	});
...
//page town
	$('.input-file-ap input[type=file]').on('change', function(){
		let file = this.files[0];
		$(this).next().html(file.name);
	});

	$('.next-bt-ans').click(function(){
		$(this).parents('.tab-answer-test').hide().next().show()
		return false;
	});

	$('.prev-bt-ans').click(function(){
		$(this).parents('.tab-answer-test').hide().prev().show()
		return false;
	});

//slider benef
	$('.slider-benef-main').slick({
		dots: false,
		arrows:true,
		slidesToShow: 2,
		slidesToScroll: 1,
...
//slider reviews
	$('.slider-big-reviews').on('init', function (event, slick) {
		$('.count-pag').text(parseInt(slick.currentSlide + 1) + ' из ' + slick.slideCount);
	});

	$('.slider-big-reviews').on('afterChange', function (event, slick, currentSlide) {
		$('.count-pag').text(parseInt(slick.currentSlide + 1) + ' из ' + slick.slideCount);
	});

	$('.slider-big-reviews').slick({
		infinite: false,
		fade: true,
		prevArrow: $('.prev-rev'),
		nextArrow: $('.next-rev'),
	...
	$('.slider-build').slick({
		infinite: false,
		prevArrow: $('.prev-build'),
		nextArrow: $('.next-build'),
		appendDots: $('.pag-build'),
		dots: true,
		slidesToShow: 1,
		slidesToScroll: 1
	});
	...
	$('.gal-conatcs').slick({
		infinite: false,
		prevArrow: $('.prev-gal-c'),
		nextArrow: $('.next-gal-c'),
		appendDots: $('.pag-gal-c'),
		dots: true,
		slidesToShow: 1,
		slidesToScroll: 1
	});
	...
	$('.slider-simple-price').slick({
		infinite: false,
		prevArrow: $('.prev-price'),
		nextArrow: $('.next-price'),
		appendDots: $('.pag-price'),
		dots: true,
		slidesToShow: 1,
		slidesToScroll: 1
	});
	...
	$('.slider-design').slick({
		...
		slidesToScroll: 1,
		mobileFirst: true,
		prevArrow: $('.desig-prev'),
		nextArrow: $('.desig-next'),
		appendDots: $('.desig-dots'),
		fade: false,
		infinite: false,
		responsive: [
			{
...
//fields
	$body.on('focus', '.field input, .textarea textarea, .placeholder input, .placeholder textarea', function () {
		$(this).parent().addClass('active');
	});
	$body.on('blur', '.field input, .textarea textarea, .placeholder input, .placeholder textarea', function () {
		let vr = $(this).val();
		if (vr.length < 1) {
...
//steps calc
	$('.next-bt-calc:not(.i)').click(function () {
		$(this).parents('.wr-item-calc-proj').hide().next().show()
		return false;
	});

	$('.prev-bt-calc').click(function () {
		$(this).parents('.wr-item-calc-proj').hide().prev().show()
		return false;
	});

//more link
	$('.swap-link a').click(function () {
...
//tabs
	$('.tabs-tb').each(function () {
		...
		$(this).find('.nav-tb li:not(.disabled)').click(function () {
			var ind = $(this).index();
	...
	$('.tabs-tb-in').each(function () {
		$(this).find('.nav-tb-in li:eq(0)').addClass('active');
		$(this).find('.nav-tb-in li').click(function () {
			var ind = $(this).index();
			$(this).parents('.tabs-tb-in').find('.cont-tb-in').find('.tab-tb-in:eq(' + ind + ')').show().siblings('.tab-tb-in:visible').hide();
			$(this).addClass('active');
			$(this).siblings('.nav-tb-in li').removeClass('active')
			return false;
		});
	});

	/*gallery image*/
	$('.img-gal-photo').each(function () {
		$(this).find('.pag-photo-gal li:eq(0)').addClass('active');
		$(this).find('.nav-photo-gal li').hover(function () {
			var ind3 = $(this).index();
			$(this).parents('.img-gal-photo').find('.l-photo-gal').find('img:eq(' + ind3 + ')').show().siblings('img:visible').hide();
			$(this).parents('.img-gal-photo').find('.pag-photo-gal').find('li:eq(' + ind3 + ')').addClass('active').siblings().removeClass('active')
		}, function () {
			$(this).parents('.img-gal-photo').find('.l-photo-gal').find('img:eq(0)').show().siblings().hide();
		});
	});

//select
	$('.tech-sel select, .sel-filter select, .sel-page select, .select-m select, .sel-mobile-sort select').selectbox();

//range
	let rageTimeout = null
	$('[data-range]').each(function () {
		let $self = $(this), opt = $self.data('range')
		console.log(opt);
		...
		$self.slider({
			...
			min: opt.val_min,
			max: opt.val_max,
			values: [opt.cur_min, opt.cur_max],
			slide: function (event, ui) {
				let min = ui.values[0], max = ui.values[1]
				$('#' + opt.id_min).val(min);
				$('#' + opt.id_max).val(max);
				if (opt.is_price) {
					min = Math.round((min / 1000000) * 100) / 100
					max = Math.round((max / 1000000) * 100) / 100
				}
				$('[data-range-inp="' + opt.id + '"] input').val(opt.t_from + min + opt.t_to + max + opt.t_end);
				clearTimeout(rageTimeout);
				rageTimeout = setTimeout(function () {
					$('#' + opt.id_min).trigger('keyup');
				}, 300);
			}
		});
	})
	...
	// 	values: [75, 300],
	// 	slide: function (event, ui) {
	// 		$('#amount').val('От ' + ui.values[0] + ' - до ' + ui.values[1] + ' млн ₽');
	// 	}
	// });
	// $('#amount').val('От ' + $('#slider-range').slider('values', 0) + ' - до ' + $('#slider-range').slider('values', 1) + ' млн ₽');
	//
	...
	// 	values: [61, 420],
	// 	slide: function (event, ui) {
	// 		$('#amount2').val('От ' + ui.values[0] + ' - до ' + ui.values[1] + ' м²');
	// 	}
	// });
	// $('#amount2').val('От ' + $('#slider-range2').slider('values', 0) + ' - до ' + $('#slider-range2').slider('values', 1) + ' м²');
	//
	...
	// 	values: [61, 420],
	// 	slide: function (event, ui) {
	// 		$('#amount3').val('От ' + ui.values[0] + ' - до ' + ui.values[1] + ' м²');
	// 	}
	// });
	// $('#amount3').val('От ' + $('#slider-range3').slider('values', 0) + ' - до ' + $('#slider-range3').slider('values', 1) + ' м²');
...
//select options
	$('.head-option').click(function () {
		$(this).next().toggle()
	});

	$(document).click(function (event) {
		if ($(event.target).closest('.sel-option').length) return;
		$('.drop-option').hide();
		event.stopPropagation();
	});

//range
	$('.field-aquare').click(function () {
		$(this).addClass('active').siblings().removeClass('active');
	});

	$(document).click(function (event) {
		if ($(event.target).closest('.field-aquare').length) return;
		$('.field-aquare').removeClass('active');
		event.stopPropagation();
	});
...
//new scripts
	...
	$('.more-citate a').click(function () {
		$(this).parent().prev().toggleClass('active view-txt')
		return false;
	});

	setTimeout(function () {
		$('.block-konstructor').each(function () {
			var heightBlock = $(this).find('.konstructor-right').height();
			var heightTxt = $(this).find('.body-konstructor2').height();
			$(this).find('.body-konstructor2').css({height: heightBlock})
			if (heightTxt > heightBlock) {
				$(this).find('.body-konstructor2').addClass('active')
			}
		});
	}, 1000);
	...
	$('.all-alpha-mob a').click(function () {
		$(this).toggleClass('active').parent().prev().toggleClass('active')
		return false;
	});

	$(document).click(function (event) {
		if ($(event.target).closest('.search-head').length) return;
		$('.search-head').hide();
		event.stopPropagation();
	});
...
//maps
		ymaps.ready(function () {
			var myMap = new ymaps.Map('map', {
				...
				myPlacemark = new ymaps.Placemark([55.6159427, 37.6088607], {
					balloonContent: '<div class="baloon-map"></div>'
				}, {
	...
	$body.on('click','.but-cookie a',function () {
		$(this).parents('.wr-panel-cookie').hide()
		SiteCookie.set('hide_panel_cookie', 'Y', {expires: 3600 * 24 * 7,})
		return false
	});
});

/* End */
;; /* /bitrix/components/arturgolubev/search.title/script.min.js?17455813056313*/
; /* /local/templates/doma-karkas/js/jquery-ui.js?1705916048529159*/
; /* /local/templates/doma-karkas/js/jquery.ui.touch-punch.min.js?17059160491291*/
; /* /local/templates/doma-karkas/js/fancybox.umd.js?1705916048141808*/
; /* /local/templates/doma-karkas/js/slick.min.js?170591605142863*/
; /* /local/templates/doma-karkas/js/jquery.selectbox.min.js?17059160493345*/
; /* /local/templates/doma-karkas/js/jquery.scrollbar.js?170591604932171*/
; /* /local/templates/doma-karkas/js/jquery.inputmask.min.js?170591604899426*/
; /* /local/templates/doma-karkas/js/webform.min.js?17061081668231*/
; /* /local/templates/doma-karkas/js/cookie.js?17416205741471*/
; /* /local/templates/doma-karkas/js/script.js?174703438018341*/
